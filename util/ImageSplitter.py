...
# Loading functions
    ...
    def process_split_image(self, current_image_path, current_image_row, left_image, right_image, split_type):
        try:
            ...
            current_seq = int(base_name.split('_')[0])
            ...
            for fname in next_images:
                try:
                    num = int(os.path.splitext(fname)[0].split('_')[0])
            ...
            left_image_path = os.path.join(os.path.dirname(current_image_path), 
                                        f"{current_seq:04d}_p{current_seq:03d}.jpg")
            right_image_path = os.path.join(os.path.dirname(current_image_path), 
